...
ssh node-$CONTR_ID "export PYTHONPATH=.:$PYTHONPATH && source ~/openrc && nosetests mos_tests/nova/windows_compatibility_tests.py --with-xunit --xunit-file=nova_tests_report.xml"
