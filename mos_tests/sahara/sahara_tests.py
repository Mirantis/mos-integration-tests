...
class SaharaScenarioTests(unittest.TestCase):
    ...
    def test_vanilla_plugin(self):
        ...
        cmd = (
            ...
            "rm -rf ~/sahara-tests && "
            "git clone https://github.com/openstack/sahara-tests && "
            "mkdir ~/sahara-tests/etc/scenario/8.0 &&"
            "cp ~/sahara-tests/etc/scenario/sahara-ci/"
            ...
            "transient.yaml.mako} ~/sahara-tests/etc/scenario/8.0 && "
            "echo '[DEFAULT]\n"
            "OS_USERNAME: admin\n"
            "OS_PASSWORD: admin\n"
